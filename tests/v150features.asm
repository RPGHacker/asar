...
;@000300
;@00 80 40 00 80 41 00 00 40 00 80 40 00 80 40 00 00 00 00 80 00 FF FF 3F 00 00 C0 00 80 C0 FF FF FF 00 00 40 00 80 40 00 80 41
;@008000
;@FF FF FF
...
lorom
	...
	table ../pushtable1.tbl	
	db "ABCD"
	
	pushtable
	
	table ../pushtable2.tbl	
	db "ABCD"
