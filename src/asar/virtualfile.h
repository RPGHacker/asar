...
public:
    ...
    size_t read_file(virtual_file_handle file_handle, void* out_buffer, size_t pos,
                     size_t num_bytes);
    ...
    inline virtual_file_error get_last_error() { return m_last_error; }

private:
    enum virtual_file_type { vft_physical_file, vft_memory_file };
