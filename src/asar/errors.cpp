...
static asar_error_mapping asar_errors[] =
{
	...
	{ error_id_expected_number, "Expected number, got string instead" },
	{ error_id_expected_string, "Expected string, got number instead" },
	{ error_id_argument_count, "Wrong number of arguments. Expected %d, got %d" },
};
